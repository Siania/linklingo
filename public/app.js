...
const STRINGS = {
  en: {
    ...
    paneSourceHint: "We’ll turn it into satirical LinkedIn speak",
    paneTarget: "LinkedIn",
    paneTargetHint: "Satirical post",
    labelRaw: "Your real phrase",
    placeholderRaw:
      "e.g. I love my ex · I ate cold pizza for breakfast · We’re out of coffee and I’m spiraling",
  ...
  uk: {
    ...
    paneSourceHint: "Перетворимо на сатиричний LinkedIn-тон",
    paneTarget: "LinkedIn",
    paneTargetHint: "Сатиричний пост",
    labelRaw: "Ваша фраза",
    placeholderRaw:
      "напр.: я досі люблю колишнього · з’їла піцу на сніданок · кави нема і я в паніці",
  ...
  de: {
    ...
    paneSource: "Klartext",
    paneSourceHint: "Wird zu satirischem LinkedIn-Sprech",
    paneTarget: "LinkedIn",
    paneTargetHint: "Satirischer Post",
    labelRaw: "Dein echter Satz",
    placeholderRaw:
      "z. B. Ich liebe noch meinen Ex · Kaltpizza zum Frühstück · Kein Kaffee und ich drehe durch",
